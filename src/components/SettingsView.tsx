...
function OllamaModelsList() {
  ...
  if (isError) return <div className="text-sm text-red-400">BÅ‚Ä…d poÅ‚Ä…czenia z Ollama</div>;
  if (!models || models.length === 0) return <div className="text-sm text-yellow-400">Brak dostÄ™pnych modeli</div>;
...
export default function SettingsView() {
  ...
  const handleSaveApiKey = async (provider: string) => {
    ...
    try {
      ...
      toast.error('B³¹d zapisywania klucza');
    }
  };
    ...
    <div className="p-6 h-full overflow-y-auto">
      ...
      <div className="space-y-6">
        ...
        <div className="glass-panel p-4">
          <h3 className="font-semibold mb-4">Wygl¹d</h3>
          ...
          {/* Language */}
          <SettingRow label={t('settings.language')} description="Zmieñ jêzyk interfejsu">
            <div className="flex gap-2">
              {languages.map((lang) => (
                <button
                  key={lang.value}
        ...
        <div className="glass-panel p-4">
          ...
          <SettingRow
            ...
            description="Automatycznie analizuj zdjêcia po wgraniu"
          >
            <button
          ...
          <SettingRow
            ...
            description="Zachowaj oryginalne zdjêcia w historii"
          >
            <button
        ...
        <div className="glass-panel p-4">
          ...
          <p className="text-sm text-matrix-text-dim mb-4">
            DostÄ™pne lokalne modele (wymagane uruchomienie Ollama).
          </p>
        ...
        <div className="glass-panel p-4">
          ...
          <p className="text-sm text-matrix-text-dim mb-4">
            WprowadŸ klucze API dla providerów AI. Klucze mo¿na te¿ ustawiæ przez zmienne œrodowiskowe.
          </p>
        ...
        <div className="glass-panel p-4">
          ...
          <div className="mt-4 pt-4 border-t border-matrix-border">
            <p className="text-xs text-matrix-text-dim text-center italic">
              "Precyzja to nie uprzejmoœæ, to wymóg." — Tissaia de Vries
            </p>
          </div>
        </div>
      </div>
